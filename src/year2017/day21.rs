...
pub fn parse_input(input: &str) -> Result<Vec<RuleBook>> {
...
fn iterate_and_count(rule_books: &[RuleBook], count: usize) -> Result<usize> {
...
pub fn task1(rule_books: &[RuleBook]) -> Result<usize> {
    iterate_and_count(rule_books, 5)
}

pub fn task2(rule_books: &[RuleBook]) -> Result<usize> {
