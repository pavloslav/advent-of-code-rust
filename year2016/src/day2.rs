...
fn code(lines: &str, map: &[&[u8]], initial: (usize, usize)) -> anyhow::Result<String> {
    let mut pos = initial;
    ...
    for line in lines.split('\n') {
        ...
        result.push(
            map.get(pos.1)
                ...
                .with_context(|| format!("Coordinates {}:{} are out of bounds!", pos.0, pos.1))?
                .to_owned()
                .into(),
        );
    }
